        ...
        <>
            ...
            <section className='d py-5'>
                <div className="container">
                    <h2 className='text-center text-white'>PROGRAMS</h2>
                </div>
            </section>
               ...
               <div className="container">
                    <div className="row">
                        <div className="col-lg-7">
                            ...
                            <h5>Strengthening the Rights of Women Home Based Workers (HBWs)
                            </h5>
                            <p>Saathi has been working with women home based workers from the slum areas from 2013 to increase their visibility and voice among policy makers and other organizations by engaging them into dialogues with city officials for required policies and programs. Saathi also provides them with skill building training, capacitating in communication and access to information and other benefits as well as group formation for their empowerment and collective strength.</p>
                            <h5>Advocacy and Networking</h5>
                              <h5>Advocacy and Awareness Raising</h5>
                              <p>To raise awareness on VAW/C and advocate on behalf of women and children, Saathi regularly organizes social mobilization programs, media campaigns, training and workshops with various stakeholders at different levels. Saathi effectively uses and localizes international UN instruments and global policies such as CEDAW, Beijing Platform for Action, ICPD and UNSCR 1325 & 1820 and its successive resolutions to strengthen accountability of national machineries and actors towards women and children’s human rights and promotion of gender equality.</p>
                              <h5>Engaging Men and Boys</h5>
                              <p>Saathi is one of the pioneer organization that initiated Engaging Men and Boys Program to address GBV. Saathi’s joint Campaign “Our Goal: Stop Violence Against Women” with All Nepal Football Association (ANFA) has been a model program nationally and globally. It has also initiated partnership with Cricket Association of Nepal (CAN), thus using the powerful potential of sports to bring about nationwide positive societal change particularly amongst the youth and men.</p>
                        </div>
                        <div className="col-lg-4">
                            ...
                            <div className='d-flex gap-4 py-3'>
                                ...
                                <div>
                                    <h6 className=''>GBV Monitoring Meeting with Local Government Focuses on 2024 Achievements and Future Plans</h6>
                                    <p>February 21, 2025</p>
                                </div>
                            </div>
